...
from mytesttab import MyTableModel
...
class BookStorageViewer(QWidget):
    ...
    def setUpUI(self):
        ...
        self.my_model = MyTableModel(self, dataList, header)
        # self.my_model.setStringList(my_list)
        self.tableView.setModel(self.my_model)

        self.my_model.setHeaderData(0, Qt.Horizontal, "书名")
        self.my_model.setHeaderData(1, Qt.Horizontal, "书号")
